...
public final class UseWarehouse {
    ...
    public static void main(final String[] args) {
         ...
         */
    	 final ComparableProduct p1 = new ComparableProduct("p1", 100);
    	 final ComparableProduct p2 = new ComparableProduct("p2", 30);
    	 final ComparableProduct p3 = new ComparableProduct("p3", 10);
